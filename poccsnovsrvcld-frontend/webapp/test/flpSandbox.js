		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "poccsnovsrvcld",
									"targetURL": "#poccsnovsrvcldfrontend-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"poccsnovsrvcldfrontend-display": {
								"semanticObject": "poccsnovsrvcldfrontend",
								"action": "display",
								"description": "Applicazione frontend Novamont con approuter standalone",
								"title": "poccsnovsrvcld",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=poccsnovsrvcldfrontend",
									"url": sap.ui.require.toUrl("poccsnovsrvcldfrontend")
								}
							}
						}
					}
